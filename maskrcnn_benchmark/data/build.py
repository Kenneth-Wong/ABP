...
from maskrcnn_benchmark.data.datasets.visual_genome import get_VG_window_distr
...
def get_dataset_statistics(cfg):
    ...
    result = {
        ...
        # 'cooccur_matrix': statistics[0]['cooccur_matrix'],
        # 'occur_num': statistics[0]['occur_num']
    }
...
def get_dataset_distribution(train_data, dataset_name):
    ...
    if is_main_process():
        ...
        for i in tqdm(range(len(train_data))):
            tgt_rel_matrix = train_data.get_groundtruth(i, need_window=False, inner_idx=False).get_field("relation")
        ...
        save_file = os.path.join(cfg.OUTPUT_DIR, "rel_freq_dist_1.png")

...
from .sgg_eval import SGRecall, SGMeanRecall
...
def do_vrd_evaluation(
    ...
    if "relations" in iou_types:
        ...
        for groundtruth, prediction in zip(groundtruths, predictions):
            evaluate_relation_of_one_image(groundtruth, prediction, global_container, evaluator, dataset.union_to_vrd_map)
        ...
        def longtail_part_eval(evaluator, mode, dataset):
            ...
            longtail_part_dict = [longtail_part_dict[vrd_to_union_map[k]] for k in sorted_vrd_keys]
        ...
        longtail_part_res_dict, longtail_part_res_str = longtail_part_eval(eval_mean_recall, mode, dataset)
...
def evaluate_relation_of_one_image(groundtruth, prediction, global_container, evaluator, predicate_map=None):
    """
    Returns:
    ...
    if evaluator.get('eval_mean_recall') is not None:
        evaluator['eval_mean_recall'].collect_mean_recall_items(global_container, local_container, mode, predicate_map)

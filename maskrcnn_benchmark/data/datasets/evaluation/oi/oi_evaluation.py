...
from ..vg.sgg_eval import SGNoGraphConstraintRecall, SGRecall, SGMeanRecall, SGNGMeanRecall, SGPairAccuracy
...
def eval_classic_recall(mode, groundtruths, predictions, predicate_cls_list,
    ...
    eval_ng_mean_recall = SGNGMeanRecall(rel_eval_result_dict, len(predicate_cls_list), predicate_cls_list,
                                         print_detail=True)

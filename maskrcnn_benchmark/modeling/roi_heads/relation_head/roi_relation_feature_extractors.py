...
class RelationFeatureExtractor(nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        # separete spatial
        self.spatial_on = self.cfg.MODEL.ROI_RELATION_HEAD.CAUSAL.SPATIAL_ON
    ...
    def forward(self, x, proposals, rel_pair_idxs=None):
        ...
        if self.cfg.MODEL.ATTRIBUTE_ON:
            ...
            union_features_att = union_att_features + rect_features if self.spatial_on else union_att_features

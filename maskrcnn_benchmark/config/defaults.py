...
# MTL Window
# -----------------------------------------------------------------------------
_C.MODEL.MTL_WINDOW = False
_C.MODEL.WINDOW_NUM = 8
_C.MODEL.MIN_WINDOW_SIZE = 32
_C.MODEL.MAX_REL_NUM = 5
_C.MODEL.MIN_WINDOW_OVERLAP = 0.1
_C.MODEL.WINDOW_LABEL_TYPE = "soft"

_C.MODEL.ROI_WINDOW_HEAD = CN()
_C.MODEL.ROI_WINDOW_HEAD.PREDICT_USE_WINDOW = True
_C.MODEL.ROI_WINDOW_HEAD.PREDICT_USE_PAIRS = False
_C.MODEL.ROI_WINDOW_HEAD.PREDICT_MULTI_OBJECT = False
_C.MODEL.ROI_WINDOW_HEAD.SPATIAL_ON = True
_C.MODEL.ROI_WINDOW_HEAD.SEPARATE_SPATIAL = False
_C.MODEL.ROI_WINDOW_HEAD.PREDICT_USE_SEMANTICS = True
_C.MODEL.ROI_WINDOW_HEAD.FEATURE_EXTRACTOR = "WindowRelationFeatureExtractor"
_C.MODEL.ROI_WINDOW_HEAD.LOSS_WEIGHT = 1.0
_C.MODEL.ROI_WINDOW_HEAD.REFINE_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_WINDOW_HEAD.NUM_WINDOW_REFINE = 1
_C.MODEL.ROI_WINDOW_HEAD.REL_SELECT = "score"  # score
_C.MODEL.ROI_WINDOW_HEAD.MIX_TYPE = "shuffle"
...
_C.MODEL.ROI_BOX_HEAD.NUM_NEW_CLASSES = -1  # only for joint training on VG and VRD
...
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT = 1.0
...
# use spatial feature or not
_C.MODEL.ROI_RELATION_HEAD.CAUSAL.SPATIAL_ON = True
...
_C.MODEL.ROI_RELATION_HEAD.DATA_RESAMPLING_PARAM.REPEAT_FACTOR = 0.07
_C.MODEL.ROI_RELATION_HEAD.DATA_RESAMPLING_PARAM.INSTANCE_DROP_RATE = 0.7
...
#
_C.SOLVER.UPDATE_OPTIM_DURING_LOAD = True
...
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "."
_C.OUTPUT_EXTRA_SUFFIX = ""
_C.OUTPUT_SAVE_REL_LOGIT = False
_C.DETECTED_SGG_DIR = "."
_C.GLOVE_DIR = "."
